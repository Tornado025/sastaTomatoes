document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fetch and display initial list of movies
    fetchMovies(1);
    ...
    function createRecommendationCard(movie) {
        return `
            <div class="recommendation-card">
                ...
                <div class="card-info">
                    <strong>Director:</strong> ${movie.director.length > 0 ? movie.director.join(', ') : 'Unknown'}
                </div>
                <div class="card-info">
                    <strong>Cast:</strong> ${movie.cast.length > 0 ? movie.cast.slice(0, 2).join(', ') : 'Unknown'}
                </div>
                <div class="card-info">
                    <strong>Genres:</strong> ${movie.genres.length > 0 ? movie.genres.slice(0, 3).join(', ') : 'Unknown'}
                </div>
